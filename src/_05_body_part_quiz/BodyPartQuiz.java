...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if(guess.equalsIgnoreCase("arnold")) {
			...
			JOptionPane.showMessageDialog(null, "He was Arnold!");
		}
		// 6. Otherwise:
		...
		String bob = JOptionPane.showInputDialog("who is this?");
		if(bob.equalsIgnoreCase("leonardo")) {
			JOptionPane.showMessageDialog(null, "You are correct!");
			score+=1;
		}
		else {
			JOptionPane.showMessageDialog(null, "You are incorrect!");
			JOptionPane.showMessageDialog(null, "He was leonardo!");
		}
		showNextImage();
		
		String jeff = JOptionPane.showInputDialog("who is this?");
		if(jeff.equalsIgnoreCase("morgan")) {
			JOptionPane.showMessageDialog(null, "You are correct!");
			score+=1;
		}
		else {
			JOptionPane.showMessageDialog(null, "You are incorrect!");
			JOptionPane.showMessageDialog(null, "He was morgan!");
		}
		showNextImage();
		
		String cad = JOptionPane.showInputDialog("who is this?");
		if(cad.equalsIgnoreCase("jack")) {
			JOptionPane.showMessageDialog(null, "You are correct!");
			score+=1;
		}
		else {
			JOptionPane.showMessageDialog(null, "You are incorrect!");
			JOptionPane.showMessageDialog(null, "He was jack!");
		}
		showNextImage();
